...
start_arr_q_table = 'arr_qtable_1.pickle'  # None or Filename
start_arr_q_table_b = 'arr_qtable_b_1.pickle'
start_arr_q_table_2 = 'arr_qtable_2.pickle'
start_arr_q_table_b_2 = 'arr_qtable_b_2.pickle'
...
for episode in range(HM_EPISODES):
    ...
    pygame.display.set_caption("Traffic Sim 1")
