...
#DOUBLE Q TABLES, DOUBLE Q LEARNING
style.use("ggplot")
...
start_arr_q_table = 'arr_qtable_1_v3.pickle'  # None or Filename
start_arr_q_table_b = 'arr_qtable_b_1_v3.pickle'
start_arr_q_table_2 = 'arr_qtable_2_v3.pickle'
start_arr_q_table_b_2 = 'arr_qtable_b_2_v3.pickle'
start_des_q_table = 'des_qtable_1.pickle'
start_des_q_table_b = 'des_qtable_2.pickle'
...
if start_arr_q_table is None:
    ...
    with open(start_arr_q_table, "rb") as f:
        arr_q_table_1 = pickle.load(f)

if start_arr_q_table_b is None:
    arr_q_table_b_1 = {}
    for i in range(0, 10):
        for ii in range(0, 10):
            for iii in range(0, 10):
    ...
    with open(start_arr_q_table_b, "rb") as f:
...
for episode in range(HM_EPISODES):
    ...
    pygame.display.set_caption("Traffic Sim 3")
